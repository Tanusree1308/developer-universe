...
import { Code2, Cpu, Brain, Atom, Trophy } from 'lucide-react'

const stats = [
    { icon: Trophy, value: '10+', label: 'Projects Built', color: '#a78bfa', glow: 'rgba(167,139,250,0.3)' },
    ...
    { icon: Brain, value: 'AI & ML', label: 'Explorer', color: '#f472b6', glow: 'rgba(244,114,182,0.3)' },
    { icon: Atom, value: 'Quantum', label: 'Learner', color: '#fb923c', glow: 'rgba(251,146,60,0.3)' },
]
...
function StatCard({ icon: Icon, value, label, color, glow, index }) {
    ...
    return (
        <motion.div
            ...
            style={{ border: `1px solid ${color}20`, transition: 'box-shadow 0.3s ease' }}
        ...
        >
            ...
            <div className="text-2xl font-black mb-1 relative z-10" style={{ color }}>{value}</div>
