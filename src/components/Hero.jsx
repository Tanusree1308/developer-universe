...
import { ArrowRight, Telescope, ChevronDown } from 'lucide-react'

const spaceObjects = [
    { label: 'Stars', color: '#fbbf24', angle: 0 },
    { label: 'Nebula', color: '#a78bfa', angle: 51 },
    { label: 'Galaxy', color: '#38bdf8', angle: 102 },
    { label: 'Quasar', color: '#f472b6', angle: 153 },
    { label: 'Pulsar', color: '#34d399', angle: 204 },
    { label: 'Comet', color: '#fb923c', angle: 255 },
    { label: 'Void', color: '#818cf8', angle: 306 },
]
        ...
        >
            ...
            >
                <div
                    ...
                    style={{ border: `1px solid ${color}40`, color, boxShadow: `0 0 12px ${color}40`, fontSize: '9px' }}
                >
                    {label}
                </div>
            </motion.div>
            ...
            <div className="max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-2 gap-16 items-center py-20">
                ...
                <div className="relative z-10">
                    ...
                    >
                        ...
                        <span className="text-sm text-slate-300 font-medium">Welcome to Developer Universe</span>
                    ...
                    >
                        ...
                        <br />
                        <span style={{ background: 'linear-gradient(135deg, #a78bfa 0%, #38bdf8 50%, #f472b6 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                            Infinite
                        </span>
                        <br />
                        <span className="text-white">Universe</span>
                        <br />
                        <span className="text-slate-400">Beyond</span>
                    </motion.h1>
                    ...
                    >
                        Journey through the cosmos — from the blazing heart of our Sun to the frozen edges of the solar system and beyond into the infinite dark.
                    </motion.p>
                    ...
                    >
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            onClick={() => document.getElementById('solarsystem')?.scrollIntoView({ behavior: 'smooth' })}
                ...
                >
                    <div className="relative w-80 h-80 lg:w-96 lg:h-96">
                        ...
                        >
                            <div className="absolute inset-0 rounded-full opacity-30" style={{ background: 'radial-gradient(circle at 60% 60%, transparent 40%, rgba(0,0,0,0.6) 100%)' }} />
                        </motion.div>
                        {spaceObjects.map((obj, i) => (
                            <OrbitIcon key={obj.label} {...obj} radius={160} duration={12 + i * 2} />
                        ))}
                    </div>
                </motion.div>
            </div>
